...
const features = [
  ...
  },
  {
    ...
    description: "Expericence lightning-fast answers to your queries, ensuring you get the information you need instantly.",
    icon: ZapIcon,
  },
  {
  ...
  {
    name: "Responseive Across Device",
    description: "Access and Ask your PDFs seamlessly on any device, whether it's your dsktop, tablet, or smartphone.",
...
export default function Home() {
  ...
  const handleClick = () => {
    if (!isSignedIn) {
      router.push("/sign-in"); // Redirect to sign-in first
    } else {
      router.push("/dashboard"); // Allow access
    }
  };
  return (
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Introducing{" "}
              <span className="font-bold text-indigo-600">Ask your PDF</span>
              <br />
              <br /> Upload your document, and our chatbot will answer questions,
              summarize content, and answer all your Queries. Ideal for everyone,
              <span className="text-indigo-600"> Ask Your PDF</span>{" "}
